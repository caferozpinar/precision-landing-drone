...
vehicleType = 1                                 # 0 for ardupilot connection 1 for sitl connection
# vehicleConnectionIP = "COM14"                   # Connection Adress
...
vehicleEnableLidar = False                      # Enables/Disables Lidar
vehicleEnableGimball = False                    # Enables/Disables Gimball
vehicleCameraType = 1                           # 0: internal raspberry cam, 1:simulation test cam, 2:test video input
...
cameraFovAngle = [120, 90]                      # cameras fov angles -1 means calculate using given frame like (1920, 1080) frame (120/1920 * 1080)
...
zAxisDefaultSpeed = 0.5                         # default z axis descent speed = 1, velocity calc = gain * default velocity
